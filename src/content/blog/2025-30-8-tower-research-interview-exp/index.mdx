...
The first round started with a friendly introduction. Since I mentioned my projects and experience, the interviewer was **keen to discuss them** even before moving to DSA, and we had a short talk about _Spring Boot_ (based on [this](https://github.com/Reckadon/Workout_Tracker) project I had in my resume). This made the conversation comfortable and engaging.
...
### Key Takeaways
1. The entire experience was **challenging** yet rewarding, and I learned that **maintaining your composure and confidence is key** during interviews. Make sure to prepare a __strong and personal__ _introduction_ for the interview.
2. A **strong grasp of DSA fundamentals** is essential. I prepared DSA by solving problems from **[Striver's A2Z DSA sheet](https://takeuforward.org/strivers-a2z-dsa-course/strivers-a2z-dsa-course-sheet-2)** in my summers. You should actually __start preparing early on__ if your goal is to crack an industrial internship.
3. Having a _record of working on multiple good projects_ (good meaning projects that __demonstrate a low-level understanding of systems development__ and also __aligns with the industry__), preferably **outside of coursework**, can significantly boost your chances in companies like Tower Research Capital, where **interns are highly valued and actually given real work**.
4. Needless to say, some experience with **Java** and enterprise frameworks like **Spring Boot** will definitely help you _stand out_.

I hope this detailed account of my interview experience **helps you** prepare better for your own interviews at TRC or similar companies. _Good luck!_
